export default {
  ...
  hero: {
    badge: 'Software Solutions & Consulting',
    titleBefore: 'Building software ',
    titleHighlight: 'that scales',
    titleAfter: ' your business',
    subtitle:
      'We build scalable software and provide expert consulting for startups and growing businesses. From idea to deployment, we are your technology partner.',
    cta: 'Contact Us',
  ...
  about: {
    label: 'Who We Are',
    title: 'About Integrant',
    p1: 'Integrant provides end-to-end software solutions, system design, and consulting services tailored for businesses and startups. We combine technical expertise with strategic thinking to deliver products that drive growth.',
  ...
  contact: {
    ...
    company: {
      title: 'Integrant',
      desc: 'Software Solutions & Consulting. We partner with startups and growing businesses to build technology that matters.',
    },
    emailCard: {
      title: 'Email Us',
