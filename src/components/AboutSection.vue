    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-4xl mx-auto">
        <div v-animate class="text-center mb-12">
          <span class="text-sm font-semibold text-blue-700 uppercase tracking-wider">{{ t('about.label') }}</span>
          <h2 class="mt-3 text-3xl sm:text-4xl font-bold text-slate-900 tracking-tight">{{ t('about.title') }}</h2>
        </div>
        ...
        <div v-animate.stagger class="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div class="bg-white rounded-2xl border border-slate-200 p-6 text-center shadow-sm">
            ...
            <div class="text-sm text-slate-500 font-medium">{{ t('about.stats.projects') }}</div>
          </div>
          <div class="bg-white rounded-2xl border border-slate-200 p-6 text-center shadow-sm">
            <div class="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <div class="text-sm text-slate-500 font-medium">{{ t('about.stats.clients') }}</div>
          </div>
          <div class="bg-white rounded-2xl border border-slate-200 p-6 text-center shadow-sm">
            <div class="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <div class="text-sm text-slate-500 font-medium">{{ t('about.stats.years') }}</div>
          </div>
        </div>
      </div>
    </div>
